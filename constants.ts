...
export const VISIBLE_WIDTH = 10; // Standard Tetris width
export const TOTAL_WIDTH = 30;   // Cylindrical width (3 screens wide)
export const VISIBLE_HEIGHT = 20; 
export const TOTAL_HEIGHT = 24;  // 4 rows of buffer at the top
